const VERSION='nongvu-ai-v21.1';
const CACHE=`${VERSION}-static`;
const STATIC=['./','./index.html','./styles.css?v=21','./app.js?v=21','./modal-fix.js?v=21','./manifest.json','./knowledge.json','./icon-192.png','./icon-512.png','./icon-180.png'];
