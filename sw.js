const VERSION='nongvu-ai-v10';
const CACHE=`${VERSION}-static`;
const STATIC=['./','./index.html','./styles.css?v=10','./app.js?v=10','./manifest.json','./data/knowledge.json','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-180.png'];
